...
- Templates are loaded from api/stages/templates/*.md.j2
- Frameworks are loaded from api/stages/frameworks/*.json
...
class StageRegistry:
    ...
    def __init__(
        ...
        Args:
            templates_dir: Path to templates directory (default: api/stages/templates)
            frameworks_dir: Path to frameworks directory (default: api/stages/frameworks)
        """
