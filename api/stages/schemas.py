...
BREAKING CHANGES:
- Engine model no longer has extraction_prompt, curation_prompt, concretization_prompt
- API endpoints /engines/{key}/*-prompt now compose prompts at runtime
- Old engine data needs migration via Alembic migration
"""
...
class StageContext(BaseModel):
    ...
    and concretization_prompt in Engine model.
    """
