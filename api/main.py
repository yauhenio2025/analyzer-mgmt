...
from routes import engines, paradigms, pipelines, consumers, changes, llm, grids, rhetoric
...
app.include_router(rhetoric.router, prefix="/api/rhetoric", tags=["Rhetoric"])
